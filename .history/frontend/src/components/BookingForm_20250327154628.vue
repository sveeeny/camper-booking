...
const calculateBasePrice = () => {
  ...
  const nights = new Date(selectedDates.value[1] - selectedDates.value[0]) / (1000 * 60 * 60 * 24);
  console.log("checkIn",selectedDates.value[0])
  console.log("checkOut",selectedDates.value[1])
  console.log("const nights",nights)
