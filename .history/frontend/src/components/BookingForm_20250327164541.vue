...
<!-- HIER FEHLER: -->
  ...
  <strong>ab 15:00 Uhr</strong>
  
  <DateDisplay :date="checkOutDate" label="Check-out bis" /> -->
  

  <div class="info-row">
  <p><strong>Check-in ab:</strong> {{ formatDateTime(checkInDate) }}</p>
  <span class="info-extra">ab 15:00 Uhr</span>
  </div>
  
  <div class="info-row">
  <p><strong>Check-out bis:</strong> {{ formatDateTime(checkOutDate) }}</p>
  <span class="info-extra">bis 11:00 Uhr</span>
</div>
