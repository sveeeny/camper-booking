...
export class BookingService {
  ...
  async createBooking(dto: CreateBookingGuestDto): Promise<any> {
    ...
    const result = await this.dataSource.query(`
      INSERT INTO ${bookingTable} (salutation, firstName, lastName, nationality, phoneCountryCode, phoneNumber, email, totalPrice)
      VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING booking_id
    `, [dto.salutation, dto.firstName, dto.lastName, dto.nationality, dto.phoneCountryCode, dto.phoneNumber, dto.email, dto.totalPrice]);

    const bookingId = result[0].booking_id;

    for (const car of dto.cars) {
      await this.dataSource.query(`
        INSERT INTO ${carsTable} (booking_id, carPlate, checkInDate, checkOutDate, isCancelled, adults, children, touristTax)
        VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
      `, [bookingId, car.carPlate, dto.checkInDate, dto.checkOutDate,, car.isCancelled, car.adults, car.children, car.touristTax]);
