import { IsString, IsIn, IsInt, Min, IsArray, IsEmail, IsNotEmpty, Matches, IsDateString, ValidateNested, MinLength,  MaxLength,  Validate,  ValidateIf,  MinDate} from 'class-validator';
import { Type } from 'class-transformer';
import { SpotAssignmentDto } from './spot-assignment.dto';
